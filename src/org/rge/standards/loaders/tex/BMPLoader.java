package org.rge.standards.loaders.tex;
...
public class BMPLoader implements Loader {
	
	public static final String[] LOADER_TYPES				= { "bmp" };
	public static final Class<?>[] LOADER_RETURN_TYPES	= { BufferedImage.class };
	...
	@Override
	public BufferedImage get(String path, AssetManager am) {
		...
		int alphaIndex = -1;
		System.out.println("Regex: " + ALPHA_REGEX + " matches: '" + path + "' = " + fileName.matches(ALPHA_REGEX));
		if(fileName.matches(ALPHA_REGEX)) {
			System.out.println("ALPHA INDEX IN PATH! " + fileName.substring(1, 3));
			try {
				alphaIndex = Integer.parseInt(fileName.substring(1, 3));
			} catch (Exception e) {}
		}
