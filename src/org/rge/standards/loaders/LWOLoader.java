...
import org.rge.standards.loaders.LwobFileData.Surface;
import org.rge.standards.loaders.LwobFileData.Surface.TextureData;

public class LWOLoader implements ModelRawDataLoader {
	
	public static final String[] MODELRAWDATALOADER_TYPES = { "lwo" };
...
//		ctm.surfLen = new int[ctm.texs.length];
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputStream in = new FileInputStream("GD_Centre_S.lwo");
